      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="nav navbar-nav">
                ...
                <?=frontend\components\MenuWidget::widget(['year' => Yii::$app->session['currentYear']])?>
              </ul>
              <ul class="nav navbar-nav navbar-right">
                ...
                <?php
                  ...
                  <?php } else {?>
                      <li><a href="#"><span class="glyphicon glyphicon-user"></span><?='  Преподаватель: '.Yii::$app->user->identity->username?></a></li>
