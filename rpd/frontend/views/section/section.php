		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					...
					<?php } else { 
						echo "<h4>Лекций не предусмотрено</h4>";
					}?>
					<?php if($discipline->selfwork) {?>
						<?php echo $form->field($section, 'selfwork_time', ['enableAjaxValidation' => true, 'enableClientValidation'=>true,])->input('number', ['class' => 'form-control'])->label("Кол-во часов на самостоятельную работу. Можно ввести до <span>$selfworkRemainTime</span> часов");?>
					<?php } else { 
						echo "<h4>Самостоятельная работа не предусмотрена</h4>";
					}?>
			...
			<div class="row">
				<div class="col-md-3 col-md-offset-9">
					...
					<?= Html::a('Отмена', Url::toRoute(['section/cancel-create-section', 'id_discipline'=> $discipline->id, 'id_section'=>$section->id]), ['class'=>'btn btn-primary']) ?>
