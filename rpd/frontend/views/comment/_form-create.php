...
<div class="col-md-8">
    ...
    <?php 
    $action = $updateComment ? Url::toRoute(['comment/update', 'id_comment'=>$commentModel->id, 'id_discipline'=>$discipline->id]) : Url::toRoute(['comment/create', 'id_discipline'=>$discipline->id]);
