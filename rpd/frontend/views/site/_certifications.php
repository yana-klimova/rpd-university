											...
											<div class="row">
												<div class="col-md-12">
													<div class="pull-right">
									  					<?php if($discipline->status==1) echo Html::a('Добавить', Url::toRoute(['current-certification/create-current-certification', 'id_discipline'=>$discipline->id]), ['class'=>'btn btn-success']);?>
									  				</div>
									  			</div>
									  		</div>
										  		<?php if($discipline->currentCertifications) {
								  					foreach ($discipline->currentCertifications as $certification):?>
														...
														<div class="row">
															<div class="col-md-12">
																<div class="pull-right">
																	<?php if($discipline->status==1) echo Html::a('Изменить', Url::toRoute(['current-certification/update-current-certification', 'id_certification'=>$certification->id, 'id_discipline'=>$discipline->id]), ['class'=>'btn btn-primary']) ?>
																	<?php if($discipline->status==1) echo Html::a('Удалить', Url::toRoute(['current-certification/delete-current-certification', 'id_certification'=>$certification->id, 'id_discipline'=>$discipline->id]), ['class'=>'btn btn-danger', 'data-confirm' => Yii::t('yii', 'Вы действительно хотите удалить данное задание?')]) ?>
																</div>			
															</div>
														</div>
										  		<?php endforeach; }?>
							...
							<div class="panel panel-default">
								...
								<div id="exam-certification" class="panel-collapse collapse certification-panel">
									<div class="row">
										<div class="col-md-12">
											<div class="pull-right">
							  					<?php if($discipline->status==1) echo Html::a('Добавить', Url::toRoute(['task-intermediate-certification/create-exam-certification', 'id_discipline'=>$discipline->id]), ['class'=>'btn btn-success']);?>
							  				</div>
							  			</div>
							  		</div>
							  		<?php if($discipline->examCertifications){
							  			foreach ($discipline->examCertifications as $certification):?>
											...
											<div class="row">
												<div class="col-md-12">
													<div class="pull-right">
														<?php if($discipline->status==1) echo Html::a('Изменить', Url::toRoute(['task-intermediate-certification/update-exam-certification', 'id_certification'=>$certification->id,  'id_discipline'=>$discipline->id]), ['class'=>'btn btn-primary']) ?>
														<?php if($discipline->status==1) echo Html::a('Удалить', Url::toRoute(['task-intermediate-certification/delete-exam-certification', 'id_certification'=>$certification->id,  'id_discipline'=>$discipline->id]), ['class'=>'btn btn-danger', 'data-confirm' => Yii::t('yii', 'Вы действительно хотите удалить данное задание?')]) ?>
													</div>	
												</div>
											</div>
								  		<?php endforeach; 
